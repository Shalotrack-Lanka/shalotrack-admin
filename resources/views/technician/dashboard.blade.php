...
<head>
    ...
    <title>ShaloTrack Technician</title>
...
<div class="flex h-screen">
    ...
    <aside class="w-72 h-screen bg-[#0B1B3F] text-white fixed left-0 top-0 overflow-y-auto">
        ...
        <div class="p-5 border-b border-blue-800 flex flex-col items-center text-center">
            ...
            <p class="text-sm text-gray-300">Technician Portal</p>
        </div>
        ...
        <nav class="px-3 pb-5 mt-2">
            ...
            <div x-data="{open:false}">
                ...
                <div x-show="open" class="ml-5 text-sm">
                    ...
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">Test Results</a>
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">Device Status</a>
                </div>
            </div>
            ...
            <div x-data="{open:false}">
                ...
                <div x-show="open" class="ml-5 text-sm">
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">Activate SIM</a>
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">SIM List</a>
            ...
            <div x-data="{open:false}">
                ...
                <div x-show="open" class="ml-5 text-sm">
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">Open Tickets</a>
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">In Progress</a>
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">Resolved Tickets</a>
                    <a href="#" class="block py-3 rounded-lg text-white hover:bg-blue-900 transition">All Tickets</a>
                </div>
            </div>

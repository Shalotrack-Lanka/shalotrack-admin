        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-3 gap-2">
                    <button onclick="sendQuickCommand('where')" class="px-3 py-2 rounded-lg border text-xs font-semibold bg-blue-50 text-blue-700 border-blue-200 hover:opacity-80 transition flex items-center gap-1.5">
                        <span>📍</span><span>Where</span>
                    </button>
                    <button onclick="sendQuickCommand('status')" class="px-3 py-2 rounded-lg border text-xs font-semibold bg-green-50 text-green-700 border-green-200 hover:opacity-80 transition flex items-center gap-1.5">
                        <span>📊</span><span>Status</span>
                    </button>
                    <button onclick="sendQuickCommand('relay_on')" class="px-3 py-2 rounded-lg border text-xs font-semibold bg-emerald-50 text-emerald-700 border-emerald-200 hover:opacity-80 transition flex items-center gap-1.5">
                        <span>🔓</span><span>Relay On</span>
                    </button>
                    <button onclick="sendQuickCommand('reset')" class="px-3 py-2 rounded-lg border text-xs font-semibold bg-orange-50 text-orange-700 border-orange-200 hover:opacity-80 transition flex items-center gap-1.5">
                        <span>🔄</span><span>Reset</span>
                    </button>
                    <button onclick="sendQuickCommand('version')" class="px-3 py-2 rounded-lg border text-xs font-semibold bg-purple-50 text-purple-700 border-purple-200 hover:opacity-80 transition flex items-center gap-1.5">
                        <span>ℹ️</span><span>Version</span>
                    </button>
                    <button onclick="sendQuickCommand('params')" class="px-3 py-2 rounded-lg border text-xs font-semibold bg-gray-50 text-gray-700 border-gray-200 hover:opacity-80 transition flex items-center gap-1.5">
            ...
            <div class="border-t pt-5">
                ...
                <div class="flex gap-2">
                    ...
                    <button onclick="sendCustomCommand()" class="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition">
                        Send
                    </button>
                </div>
            </div>

                        ...
                        <div class="p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start w-full">
                            <form method="POST" action="#" class="lg:col-span-5 space-y-4 max-w-xl w-full text-xs font-semibold text-gray-700">
                                ...
                                <div>
                                    ...
                                    <select name="product_name" class="w-full rounded-lg border-gray-300 h-9">
                                        <option value="" selected>--Select--</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="block mb-1">Feature Name</label>
                                    <select name="feature_name" class="w-full rounded-lg border-gray-300 h-9">
                                        <option value="No Data" selected>No Data</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="block mb-1">Feature Remarks</label>
                                    <textarea name="feature_remarks" rows="4" class="w-full rounded-lg border-gray-300"></textarea>
                                </div>

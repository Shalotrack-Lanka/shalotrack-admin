...
<head>
    ...
    <style>
        ...
        /* Watermark: position:fixed makes dompdf repeat this on every page.
           z-index -1 + low opacity keeps it behind the content, not on top of it.
           Centered via left:50% + negative margin-left (dompdf doesn't reliably
           support transform:translate, this is the safe centering trick).
           NOTE: table rows must NOT have opaque backgrounds or they will
           block the watermark wherever they overlap it — zebra-striping
           was removed below for that reason. */
        .watermark {
            position: fixed;
            top: 300px;
            left: 50%;
        ...
        /* Zebra striping intentionally removed — see note above. */
        .footer {
            margin-top: 20px;
            font-size: 9px;
            color: #999;
...
<body>
    ...
    {{-- Watermark: same icon + wordmark + tagline as the login page, just faint and large --}}
    <div class="watermark">
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 27%;">IMEI</th>
                <th style="width: 27%;">Model</th>
                <th style="width: 20%;">SIM Number</th>
                <th style="width: 18%;">Setup Date</th>
            </tr>
        </thead>
        <tbody>

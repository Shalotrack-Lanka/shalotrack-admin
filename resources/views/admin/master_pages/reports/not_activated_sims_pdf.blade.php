...
<head>
    ...
    <style>
        ...
        .status-pill {
            ...
            font-size: 9px; font-weight: bold; background-color: #fdecea; color: #b3261e;
        }
        ...
        <tbody>
            @forelse($sims as $sim)
                <tr>
                    ...
                    <td><span class="status-pill">Not Activated</span></td>
                </tr>
            @empty
                <tr><td colspan="5" style="text-align: center; color: #999;">No pending SIMs found.</td></tr>
            @endforelse
        </tbody>
    </table>
